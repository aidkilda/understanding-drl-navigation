...
def rollout(env):
    ...
    while True:
        ...
        if human_agent_action is not None:
            ...
            human_agent_action = None
            print("Current location", env.locations[int(env.current_state_id)])
            print("Current rotation", env.rotations[int(env.current_state_id)])
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        "--scene_dump",
        type=str,
        default="./data/living_room_08.h5",
